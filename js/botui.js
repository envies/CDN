...
!function(e, t) {
    ...
    return function(t, n) {
        ...
        g.fontawesome && r("https://cdn.jsdelivr.net/gh/envies/CDN@202012211100/js/085aa75923.js"),
        g.debug && (h._botApp = f),
        h
    }
});
...
/*
     * BotUI回复配置
     */
    function bot_ui_ini(){var botui = new BotUI("hello-ushio");
    botui.message.bot({
        delay: 200,
        content: "Hi, there👋"
    }).then(function() {
        ...
        if (res.value == "gg") {
            return botui.message.bot({
                delay: 1500,
                content: "![](https://cdn.jsdelivr.net/gh/envies/CDN@202012211100/image/about/sanlian.jpg)"
            })
        }
    });
    ...
    var other = function() {
        botui.message.bot({
            ...
            return botui.message.bot({
                delay: 1500,
                content: "主要向系统方面前进，比较平平无奇"
            })
        }).then(function() {
            return botui.message.bot({
                delay: 1500,
                content: "平时会打打羽毛球和乒乒球，篮球可太累了"
            })
        }).then(function() {
            return botui.action.button({
                delay: 1500,
            ...
            return botui.message.bot({
                delay: 1500,
                content: "因为名字中有岭字，玩游戏填入ID时也常用这个，就一直用着了！"
            })
        }).then(function() {
            return botui.action.button({
                delay: 1500,
